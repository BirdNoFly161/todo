            ...
            >
              ...
              <div className="flex flex-col">
                  ...
                  <div className="flex items-center">
                    ...
                    />
                    {formik.touched.username && formik.errors.username ? <BiErrorCircle className="text-red-500" /> : <div className="w-[1em] h-[1em]" />}
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex items-center">
                    ...
                    <input
                      ...
                      onChange={formik.handleChange}
                    />
                    {formik.touched.password && formik.errors.password ? <BiErrorCircle className="text-red-500" /> : <div className="w-[1em] h-[1em]" />}
