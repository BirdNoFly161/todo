...
function Task({ title, deadline }) {
  return (
    <div className="flex w-full bg-primary rounded">
      <span className="flex justify-center bg-secondary rounded-tl rounded-bl w-1/5 px-2 py-1">
        {title}
      </span>
      {deadline && (
      ...
      <span className="flex grow justify-center items-center bg-secondary px-2 rounded-tr rounded-br border-l border-accent">
        More details
      </span>
    </div>
  );
