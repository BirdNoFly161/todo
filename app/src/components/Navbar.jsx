        ...
        {user ? (
          <>
            <span
              ...
              className="text-lg flex flex-col justify-center bg-background border border-primary text-center w-10 h-10 rounded-full cursor-pointer hover:border-white transition-all"
            >
              {user.image && (
